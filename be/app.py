...
def search():
    ...
    try:
        ...
        formatted_results = []
        print("Clips returned:", len(search_results.data))
        ...
        for clip in search_results.data:
            try:
                ...
                print(f"Fetching video info for: {clip.video_id}")
                ...
                if url_response.status_code == 200:
                    ...
                    app.logger.error(f"Video fetch failed: {url_response.status_code} - {url_response.text}")
                    continue
